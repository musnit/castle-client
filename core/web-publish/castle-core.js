...
// refer to Module (if they choose; they can also define Module)
  ...
  Module['FS_createPath']("/", "assets", true, true);
   ...
   loadPackage({"files": [{"filename": "/assets/test-motion-sliding.json", "start": 0, "end": 35511, "audio": 0}, {"filename": "/assets/test-motion-speed-limit.json", "start": 35511, "end": 62402, "audio": 0}, {"filename": "/assets/test-c++-aquarium.json", "start": 62402, "end": 189612, "audio": 0}, {"filename": "/assets/test-drawing2.json", "start": 189612, "end": 199584, "audio": 0}, {"filename": "/assets/test-watch.json", "start": 199584, "end": 829517, "audio": 0}, {"filename": "/assets/test-rules-1.json", "start": 829517, "end": 844546, "audio": 0}, {"filename": "/assets/test-motion-slowdown.json", "start": 844546, "end": 878110, "audio": 0}, {"filename": "/assets/test-motion-basic.json", "start": 878110, "end": 926509, "audio": 0}, {"filename": "/assets/keepme.txt", "start": 926509, "end": 926523, "audio": 0}, {"filename": "/assets/test-analog-stick-drag.json", "start": 926523, "end": 942168, "audio": 0}, {"filename": "/assets/test-sling-drag.json", "start": 942168, "end": 968916, "audio": 0}], "remote_package_size": 968916, "package_uuid": "86084ef1-0965-4192-b42b-4ccb5dd1f137"});
...
var ASM_CONSTS = {
  889707: function($0, $1) {alert(UTF8ToString($0) + "\n\n" + UTF8ToString($1));},  
 ...
 891219: function($0, $1, $2, $3, $4) {var w = $0; var h = $1; var hot_x = $2; var hot_y = $3; var pixels = $4; var canvas = document.createElement("canvas"); canvas.width = w; canvas.height = h; var ctx = canvas.getContext("2d"); var image = ctx.createImageData(w, h); var data = image.data; var src = pixels >> 2; var dst = 0; var num; if (typeof CanvasPixelArray !== 'undefined' && data instanceof CanvasPixelArray) { num = data.length; while (dst < num) { var val = HEAP32[src]; data[dst ] = val & 0xff; data[dst+1] = (val >> 8) & 0xff; data[dst+2] = (val >> 16) & 0xff; data[dst+3] = (val >> 24) & 0xff; src++; dst += 4; } } else { var data32 = new Int32Array(data.buffer); num = data32.length; data32.set(HEAP32.subarray(src, src + num)); } ctx.putImageData(image, 0, 0); var url = hot_x === 0 && hot_y === 0 ? "url(" + canvas.toDataURL() + "), auto" : "url(" + canvas.toDataURL() + ") " + hot_x + " " + hot_y + ", auto"; var urlBuf = _malloc(url.length + 1); stringToUTF8(url, urlBuf, url.length + 1); return urlBuf;},  
 892208: function($0) {if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } return 0;},  
 892301: function() {if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; }},  
 892370: function() {return screen.width;},  
 892395: function() {return screen.height;},  
 892421: function() {return window.innerWidth;},  
 892451: function() {return window.innerHeight;},  
 892482: function($0) {if (typeof setWindowTitle !== 'undefined') { setWindowTitle(UTF8ToString($0)); } return 0;},  
 892577: function() {if (typeof(AudioContext) !== 'undefined') { return 1; } else if (typeof(webkitAudioContext) !== 'undefined') { return 1; } return 0;},  
 892714: function() {if ((typeof(navigator.mediaDevices) !== 'undefined') && (typeof(navigator.mediaDevices.getUserMedia) !== 'undefined')) { return 1; } else if (typeof(navigator.webkitGetUserMedia) !== 'undefined') { return 1; } return 0;},  
