...
int HorizontalSwipeFeed::getCurrentIndex() {
...
void HorizontalSwipeFeed::update(double dt) {
...
void HorizontalSwipeFeed::makeShader() {
...
void HorizontalSwipeFeed::fetchMoreDecks() {
  if (fetchingDecks) {
    return;
  }
...
void HorizontalSwipeFeed::loadDeckAtIndex(int i) {
...
void HorizontalSwipeFeed::unloadDeckAtIndex(int i) {
  if (i >= (int)decks.size() || i < 0) {
    return;
  }
...
love::graphics::Canvas *HorizontalSwipeFeed::newCanvas(int width, int height) {
...
void HorizontalSwipeFeed::renderToCanvas(
