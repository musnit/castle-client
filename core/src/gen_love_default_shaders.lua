...
function love_graphics__shaderCodeToGLSL(gles, arg1, arg2)
...
function love_graphics__transformGLSLErrorMessages(message)
...
print("// Generated by 'gen_love_default_shaders.lua'\n")
for k1, v in pairs(defaults) do
    for k2, code in pairs(v) do
        print('static const char *love_default_' .. k1 .. '_' .. k2 .. ' = R"SHADER(\n' .. code .. '\n)SHADER";')
    end
end
for k1, v in pairs(defaults_gammacorrect) do
    for k2, code in pairs(v) do
        print('static const char *love_default_gammacorrect_' .. k1 .. '_' .. k2 .. ' = R"SHADER(\n' .. code .. '\n)SHADER";')
    end
end
