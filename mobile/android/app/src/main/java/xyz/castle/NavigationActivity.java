...
public class NavigationActivity extends FragmentActivity implements DefaultHardwareBackBtnHandler, PermissionAwareActivity, JsDevReloadHandler.ReloadListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        new CastleNavigationScreen("HomeScreenRoot", (Activity activity) -> (new CastleStackNavigator(this, "HomeScreen"))).register();

        new CastleNavigationScreen("ExploreScreenStack", (Activity activity) -> (new CastleStackNavigator(this, "ExploreScreen"))).register();
    ...
    public void onRNEvent(RNEvent rnEvent) {
        ...
        ReactInstanceManager reactInstanceManager = reactGateway.reactInstanceManager();
        ...
        module.emit(rnEvent.eventName, rnEvent.data);
    }
    ...
    protected void onPause() {
        ...
        onRNEvent(new RNEvent("onAppStateChange", "background"));
    }
    ...
    public void sendSmartLockCredentials(final Credential credential) {
        ...
        if (username != null && password != null) {
            ...
            onRNEvent(new RNEvent("CastleSmartLockCredentials", payload));
        }
    }
