...
struct Archive2 {
  Archive2(const Archive2 &) = delete;
  auto operator=(const Archive2 &) -> Archive2 & = delete;

  Archive2(Archive2 &&) = default;
  auto operator=(Archive2 &&) -> Archive2 & = default;
  ...
  static auto fromFile(const std::string &path) -> Archive2 {
    Archive2 ar;
  ...
  static auto fromString(const char *json) -> Archive2 {
    Archive2 ar;
    ar.root.Parse(json);
    return ar;
  }
